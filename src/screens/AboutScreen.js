    ...
    <ScrollView>
      <Card>
        ...
        <Text style={{ margin: 10 }}>
          Each decade since 1952, the British Film Institute's Sight and Sound
          Magazine has been putting out a carefully compiled list of the
          greatest films of all time. The published lists are usually 10 titles
          long, but in 2012 they put out a whopping 250 titles.
        </Text>
        <Text style={{ margin: 10 }}>
          I wanted a tool to help me track my way through the list. I had three
          basic criteria:
        </Text>
        <Text style={{ margin: 10 }}>
          * A visually simple progress bar. This tool does ONE thing.
        </Text>
        <Text style={{ margin: 10 }}>* Mobile-friendly.</Text>
        <Text style={{ margin: 10 }}>
      ...
      <Card>
        ...
        <Card.Divider />
        <Text>
          The frontend is hosted on SiteGround, the backend is hosted on Heroku,
          and the app is availabe on Expo Snack.
        </Text>
      </Card>
      <Card>
        <Card.Title>
        ...
        <Button
          ...
          style={styles.linkButton}
          onPress={() =>
            Linking.openURL('https://github.com/ejw773/bfi250-node-server')
          }
        />
        <Button
          ...
          style={styles.linkButton}
          onPress={() =>
            Linking.openURL('https://github.com/ejw773/bfi250-mobile')
          }
        />
        <Button
