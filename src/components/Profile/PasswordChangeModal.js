...
const PasswordChangeModal = (props) => {
    ...
    return (
        <Modal animationType="slide" 
            transparent={false} visible={showPasswordChange} 
            ...
            <View style={styles.card}>
                <Card>
                    ...
                    <Button style={styles.formButton} buttonStyle={{backgroundColor: 'gray'}} title="Cancel" onPress={handleClosePasswordChange} />
                </Card>
            </View>
        </Modal>
    )
