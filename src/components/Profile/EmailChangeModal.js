...
const EmailChangeModal = (props) => {
    ...
    return (
        <Modal animationType="slide" 
            transparent={false} visible={showEmailChange} 
            ...
            <View style={styles.card}>
                <Card>
                    ...
                    />    
                    <Card.Divider/>
                    <Button style={styles.formButton} title="Change Email" onPress={handleEmailChange} />
                    <Button style={styles.formButton} buttonStyle={{backgroundColor: 'gray'}} title="Cancel" onPress={handleCloseEmailChange} />
                </Card>
            </View>
        </Modal>
    )
